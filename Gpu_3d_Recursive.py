################################################################
    ...
    # Function [Grl,Grd,Gru,Gnl,Gnd,Gnu,Gpl,Gpd,Gpu] = Gpu_3d_Recursive(Np,Al,Ad,Au,Sigin,Sigout)
...
@cuda.jit
def Gpu_3d_Recursive(AD, ALD, AUD, Sigin, Sigout, gaL, grL, ginL, gipL, Grl, Grd, Gru, 
